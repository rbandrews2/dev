...
async function main() {
  ...
  console.log("  - Supabase publishable key (Project settings -> API -> publishable key)");
  ...
  const supabasePublishableKey = await ask("Supabase publishable key", { required: true });
  ...
  const envValues = {
    ...
    VITE_SUPABASE_PUBLISHABLE_KEYS: supabasePublishableKey,
