    ...
    <div className="min-h-screen text-yellow-100 pb-14">
      <section className="max-w-6xl mx-auto px-4 pt-8 pb-6 space-y-6">
        ...
        <Link to="/training/videos" className="block">
          <GlassCard className="p-5 bg-black/60 border border-amber-500/25 hover:border-amber-400/40 hover:bg-black/65 transition">
            ...
            return (
              <Link key={course.course_id} to={`/training/course/${course.course_id}`} className="block">
                <GlassCard className="h-full p-5 flex flex-col gap-3 bg-black/60 border border-amber-500/25 hover:border-amber-400/40 hover:bg-black/65 transition">
                  ...
                  <div className="mt-auto flex flex-wrap items-center gap-2 text-[11px] uppercase tracking-[0.14em] text-amber-200/80">
