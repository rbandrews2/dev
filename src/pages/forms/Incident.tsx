  ...
  return (
    <div className="min-h-screen pb-16 max-w-4xl mx-auto space-y-4">
      <div>
        ...
        <p className="text-sm text-amber-100/75 mt-1">
      ...
      <GlassCard className="p-5 space-y-4">
        <input
          className="w-full p-3 rounded bg-black/30 border border-amber-400/30 text-white"
          placeholder="Title"
          value={data.title}
        ...
        <button
          onClick={submit}
          disabled={submitting}
          className="px-6 py-3 bg-amber-500 rounded text-black font-bold hover:bg-amber-400 transition disabled:opacity-60 disabled:cursor-not-allowed"
        >
