...
export default function PurchaseCancelled() {
  return (
    <div className="mx-auto max-w-3xl rounded-3xl border border-amber-500/20 bg-black/40 p-8">
      <p className="text-xs uppercase tracking-[0.18em] text-amber-200/70">Checkout cancelled</p>
      ...
      <div className="mt-6 flex gap-3">
        <Link to="/" className="rounded-xl bg-amber-500 px-4 py-3 font-semibold text-black hover:bg-amber-400">
          Return home
        </Link>
