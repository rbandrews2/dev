...
const priorityColors = {
  ...
  return (
    <div 
      onClick={onClick}
      className={`bg-wz_glass backdrop-blur-xl border border-wz_border rounded-xl shadow-glow p-5 hover:shadow-glow-strong transition-all cursor-pointer border-l-4 ${priorityColors[priority]} hover:border-amber-400/50 hover:bg-white/5`}
    >
